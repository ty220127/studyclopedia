...
j++; cu7 = j; bns[i][j] = "頂点のクラスタリングと単位ベクトル";
j++; ci7 = j; bns[i][j] = "命題：クラスタリングベクトルによる初期状態の記述";
j++; cS7 = j; bns[i][j] = "命題：クラスタリングベクトルとシフト作用素";
j++; cC7 = j; bns[i][j] = "命題：クラスタリングベクトルとコイン作用素";
j++; cQ7 = j; bns[i][j] = "命題：クラスタリングベクトルとオラクル";
